...
Sound Midi::scale(
    ...
    (uint16_t[]) {50, 50, 50, 50, 50, 50, 50, 50}
);
...
Sound Midi::bpwa(
    ...
    (uint8_t[]) {120, 120, 120, 122, 121, 120, 121, 120, 119, 120, 122, 121, 120, 119, 120, 121, 120, 121, 120, 119,
                 120},
    (uint16_t[]) {3, 2, 14, 2, 5, 9, 4, 3, 7, 4, 2, 3, 2, 5, 7, 4, 14, 2, 3, 6, 2},
    -22,
    2
);
...
Sound Midi::brcr(
    ...
    (uint16_t[]) {5, 4, 2, 2, 5, 14, 14, 2, 12, 2, 3, 2, 5, 2, 2, 18, 3, 2, 3, 2, 14, 2, 2, 3, 2, 3, 10, 2, 2, 2, 2, 5,
                 2},
    -22,
    1
);
...
Sound Midi::cardinal(
    ...
    (uint16_t[]) {4, 3, 5, 2, 2, 7, 7, 4, 3, 2, 2, 3, 2, 2, 10, 11, 5, 5, 7, 4, 2, 7, 7, 5, 2, 5, 2, 7, 2, 3, 5, 2, 2, 5,
...
Sound Midi::indigobu(
    ...
    (uint8_t[]) {111, 110, 110, 111, 112, 116, 114, 116, 110, 103, 104, 110, 109, 107, 106, 105, 106, 115, 114, 115,
                 ...
                 103, 105, 106},
    (uint16_t[]) {2, 5, 2, 3, 9, 2, 3, 2, 2, 3, 2, 3, 7, 2, 5, 2, 2, 2, 2, 3, 2, 2, 3, 5, 4, 3, 9, 7, 4, 2, 3, 2, 2, 7,
...
Sound Midi::junco(
    ...
    (uint16_t[]) {3, 2, 5, 2, 5, 2, 2, 5, 2, 2, 2, 3, 2, 2, 2, 5, 2, 3, 2, 5, 2, 2, 5, 2, 2, 2, 3, 2, 2, 2, 5, 2, 3, 3,
...
Sound Midi::mowa(
    ...
    (uint16_t[]) {3, 10, 4, 4, 3, 3, 4, 3, 4, 7, 3, 3, 4, 3, 4, 3, 3, 3, 4, 3, 4, 3, 4, 3, 3, 4, 3, 7, 4, 3, 3, 4, 3, 4,
...
Sound Midi::oriole(
    ...
    (uint8_t[]) {101, 100, 99, 100, 98, 101, 100, 99, 100, 98, 100, 107, 105, 101, 99, 100, 99, 100, 98, 101, 100, 100,
                 101, 100, 99},
    (uint16_t[]) {4, 3, 7, 7, 17, 3, 10, 7, 3, 4, 14, 3, 3, 4, 4, 3, 4, 10, 17, 7, 17, 3, 7, 6, 14},
    -15,
    1
);
...
Sound Midi::osprey(
    ...
    (uint16_t[]) {5, 7, 2, 2, 2, 7, 2, 4, 5, 2, 2, 2, 5, 2, 7, 2, 2, 5, 2, 5, 7, 3, 2},
    -15,
    1
);
...
Sound Midi::oven(
    ...
    (uint16_t[]) {2, 2, 2, 2, 2, 5, 2, 2, 3, 2, 2, 3, 2, 3, 2, 2, 3, 2, 2, 3, 2, 2, 2, 2, 5, 2, 2, 3, 4, 2, 2, 7, 5, 2,
...
Sound Midi::songspar(
    ...
    (uint8_t[]) {117, 117, 117, 117, 117, 112, 111, 112, 111, 112, 112, 113, 112, 113, 112, 113, 112, 111, 112, 111,
                 ...
                 102},
    (uint16_t[]) {16, 13, 14, 11, 9, 7, 2, 19, 2, 5, 12, 2, 9, 3, 4, 3, 4, 3, 41, 3, 2, 10, 2, 2, 9, 4, 9, 2, 7, 2, 2, 2,
...
Sound Midi::towhee(
    ...
    (uint16_t[]) {3, 2, 2, 3, 5, 5, 3, 2, 2, 2, 3, 2, 2, 2, 3, 2, 2, 2, 3, 3, 2, 2, 3, 3, 2, 2, 5, 3, 2, 14, 2, 2, 3, 2,
...
Sound Midi::tuftedti(
    ...
    (uint8_t[]) {101, 100, 101, 100, 99, 98, 97, 101, 100, 99, 97, 98, 101, 100, 98, 97, 102, 101, 100, 99, 98, 97, 101,
                 ...
                 98},
    (uint16_t[]) {7, 3, 7, 7, 2, 2, 5, 21, 2, 3, 2, 2, 18, 7, 3, 2, 2, 19, 4, 3, 2, 2, 11, 7, 3, 2, 5, 2, 3, 7, 11, 3, 2,
...
Sound Midi::veery(
    ...
    (uint16_t[]) {2, 2, 3, 2, 5, 3, 2, 2, 2, 2, 2, 2, 2, 4, 2, 7, 5, 2, 3, 2, 3, 2, 2, 3, 2, 5, 2, 9, 5, 2, 3, 4, 3, 7,
                 7, 5, 7, 7,
...
Sound Midi::whthsprw(
    ...
    (uint16_t[]) {4, 12, 2, 2, 3, 2, 5, 4, 21, 3, 18, 2, 2, 2, 3, 2, 5, 34, 5, 7, 2, 10, 7, 30, 2, 10, 2, 33, 2, 3, 12,
                 16, 3, 4},
    -15,
    1
);
...
Sound Midi::wiwa(
    ...
    (uint16_t[]) {3, 2, 2, 2, 2, 3, 2, 2, 3, 2, 3, 2, 2, 3, 2, 3, 2, 2, 3, 2, 7, 2, 2, 3, 2, 2, 3, 4, 2, 2, 3, 2, 2, 3,
...
Sound Midi::wind(
    ...
    127,
    21,
    (uint8_t[]) {74, 69, 71, 69, 67, 67, 71, 69, 70, 71, 71, 72, 74, 69, 67, 67, 71, 69, 67, 14,
                 31, 50, 62},
    (uint16_t[]) {60, 60, 62, 62, 62, 64, 66, 74, 72, 72, 74, 76, 78, 80, 82, 82, 60, 96, 76, 73,
                 96, 96, 76},
    -15,
    1
);
